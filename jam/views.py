...
def empchengepassword(request):
    try:
        if request.session['employer']:
            return render(request,'empchengepassword.html')
    except:
        return render(request,'login.html')
...
def empchengepwd(request):
    ...
    if newpassword!=confirmpassword:
        ...
        return render(request,'empchengepassword.html',{'msg':msg})
    ...
    try:
        ...
        msg=msg+' Old Password Dosn`t Match'
    return render(request,'empchengepassword.html',{'msg':msg})
...
def jobchengepassword(request):
    try:
        if request.session['jobseeker']:
            return render(request,'jobchengepassword.html')
    except:
        return render(request,'login.html')
...
def jobchengepwd(request):
    oldpassword = request.POST['oldpassword']
    newpassword = request.POST['newpassword']
    confirmpassword = request.POST['confirmpassword']
    msg='Massage='
    if newpassword!=confirmpassword :
        msg=msg+'New Password And Confirmed New Password Are Not Equal'
        return render(request,'jobchengepassword.html',{'msg':msg})
    ...
    try:
        ...
        msg=msg+'Old Password Doesn`t Match'
        return render(request,'jobchengepassword.html',{'msg':msg})
